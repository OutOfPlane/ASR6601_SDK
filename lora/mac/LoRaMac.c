 ...
 */
static void OnRxWindow1TimerEvent( );
 ...
 */
static void OnAckTimeoutTimerEvent( );
            ...
            case SRV_MAC_DEVICE_TIME_ANS:
                {
                    ...
                    sysTime = SysTimeAdd( sysTimeCurrent, SysTimeSub( sysTimeAns, LastTxSysTime ) );
