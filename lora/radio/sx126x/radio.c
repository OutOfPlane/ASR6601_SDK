 ...
 */
void RadioOnTxTimeoutIrq( );

/*!
 * \brief Rx timeout timer callback
 */
void RadioOnRxTimeoutIrq( );

/*!
 * \brief Cad timeout timer callback
 */
void RadioOnCadTimeoutIrq( );
/*
